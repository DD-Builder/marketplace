...
# --- Adapter --------------------------------------------------------------
# The verified Apify adapter now lives in the package so the pilot and the live
# engine share one implementation. Kept as `to_raw` for back-compat.
from dealfinder.sources.apify import record_to_listing as to_raw  # noqa: E402
